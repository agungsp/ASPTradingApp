...
{
    public partial class MasterBlankForm : Form
    {
        ...
        private void MasterBlankForm_Load(object sender, EventArgs e)
        {

        }

        private void MasterBlankForm_KeyDown(object sender, KeyEventArgs e)
        {
            EventNavigation(e);
        }
